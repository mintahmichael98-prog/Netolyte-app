...
const MapView = ({ leads }) => {
    ...
    return (_jsxs("div", { className: "h-full w-full rounded-xl overflow-hidden border border-slate-200 dark:border-slate-700 shadow-sm relative z-0 flex flex-col", children: [_jsx("div", { ref: mapContainerRef, className: "flex-1 w-full bg-slate-100 dark:bg-slate-900" }), isGeocoding && (_jsxs("div", { className: "absolute top-4 left-1/2 transform -translate-x-1/2 bg-white/90 dark:bg-slate-800/90 backdrop-blur-md px-4 py-2 rounded-full shadow-lg z-[1000] border border-indigo-100 dark:border-indigo-900 flex items-center gap-3", children: [_jsx(Loader2, { className: "w-4 h-4 animate-spin text-indigo-600" }), _jsxs("span", { className: "text-xs font-semibold text-slate-700 dark:text-slate-200", children: ["Locating satellites... ", geocodingProgress, " / ", leads.filter(l => !l.coordinates).length] })] })), _jsxs("div", { className: "absolute bottom-6 left-6 bg-white/90 dark:bg-slate-800/90 backdrop-blur-md p-4 rounded-xl shadow-xl z-[1000] border border-slate-200 dark:border-slate-700 max-w-xs", children: [_jsxs("div", { className: "flex items-center gap-2 mb-2", children: [_jsx("div", { className: "p-1.5 bg-indigo-100 dark:bg-indigo-900/50 rounded-lg", children: _jsx(Globe, { className: "w-4 h-4 text-indigo-600 dark:text-indigo-400" }) }), _jsxs("span", { className: "font-bold text-sm text-slate-900 dark:text-white", children: [processedLeads.filter(l => l.coordinates).length, " Located"] })] }), _jsx("p", { className: "text-[10px] text-slate-500 dark:text-slate-400 leading-relaxed", children: "Using OpenStreetMap Geocoding for precision. Some addresses may be approximate." })] })] }));
};
